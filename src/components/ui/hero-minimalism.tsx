...
.content .desc {
  ...
  max-width: 680px;
      ...
      {/* Particles (handled by global ParticleBackground) */}
      <canvas ref={canvasRef} className="particleCanvas" style={{ display: "none" }} />
      ...
      <main className="hero">
        <div>
          <div className="kicker">Presentation AI Training Platform</div>
          <h1 className="title">Build the pipeline.<br/>Own the data.</h1>
          <p className="subtitle">Turn your best designers into a continuous AI training pipeline. Every operation captured, every decision explained.</p>
        </div>
      </main>

      {/* Bottom content */}
      <section className="content">
        <div className="tag">Centers of Excellence</div>
        <div className="heading">Your designers. Your data. Your moat.</div>
        <p className="desc">
          Equip expert designers with the capture plugin. Deploy them on real projects. Training data is a byproduct of billable work — not a separate cost center.
        </p>
      </section>
    </section>
  );
